...
class TestModelIDConsistency:
    ...
    def test_default_weights_model_ids_in_allowlist(self):
        ...
        default_weight_model_ids = {"kimi-k2.6:cloud", "glm-5.3:cloud"}
    ...
    def test_client_model_ids_in_allowlist(self):
        ...
        from src.llm.client import OllamaKimiClient, OllamaQwen35Client, OllamaDeepseekClient, OllamaGlmClient, OllamaGLM53Client

        for client_cls in (OllamaKimiClient, OllamaQwen35Client, OllamaDeepseekClient, OllamaGlmClient, OllamaGLM53Client):
