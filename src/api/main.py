...
from src.api.routes import admin, auth, backtest, config_routes, llm_routes, news_routes, performance, portfolio, signals, strategies, trading, system_routes, pead_routes, validation_routes, labeling_routes, quality_routes  # noqa: E402
