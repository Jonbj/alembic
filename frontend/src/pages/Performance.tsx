    ...
    <div style={{ position: 'relative' }}>
      <HelpButton title="Performance — Rendimento" sections={[
        ...
        },
        {
          ...
          content: "**Regime**: stato del mercato rilevato dal RegimeDetector — bull / sideways / bear / high_vol (in caso di disaccordo tra i modelli vince il regime più conservativo).\n**Multiplier (×N)**: moltiplicatore di POSITION SIZING applicato al notional degli ordini BUY alla submit (non alla soglia): bull ×1.0, sideways ×0.7, bear ×0.4, high_vol ×0.2.\n**Capitale trattenuto vs bull**: quanta liquidità stiamo tenendo rispetto a un regime bull — il costo del regime di cautela.\n\n**Threshold corrente**: soglia minima di score per aprire un trade S4 (baseline 0.30, max 0.60). Si alza dopo 3 perdite consecutive o un rolling loss > 0.5% dell'equity; rientra con 3 vittorie consecutive o per decay automatico dopo 24h senza trigger.\n**Regime scale ×N**: stato Redis legacy/audit — consumato solo dal path legacy execution.py, NON dal portfolio scheduler.",
        },
        {
