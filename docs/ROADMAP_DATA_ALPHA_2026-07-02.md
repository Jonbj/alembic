...
| **ALPHA-A3** | Wire transcripts (alpha qualitativo) | P2 | A2 | zero handling transcript; è dove LLM tone-analysis brilla | FMP `/earning_call_transcript`, Polygon transcripts | tone signal estratto da transcript, validato su label set → **POC NOT EXECUTED 2026-07-04**: transcript FMP gated su piano Ultimate ($99/mo); il PO ha acquistato Starter ($29/mo, non li include) e ha scelto di non fare l'upgrade — nessun dato raccolto (`reports/s7_poc/S7_REVIVAL_DECISION_REPORT_2026-07-04.md`) |
