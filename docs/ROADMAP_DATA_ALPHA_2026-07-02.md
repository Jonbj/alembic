...
| **ALPHA-A5** | POC backtest S7 (gate go/no-go) | P1 | A2 | S7 mai validato con dati reali | backtest 1 anno FMP | **drift netto ≥1.5% a 20d, hit-rate >55%, test esplicito large vs small cap** (se large-cap drift ≈0 → alpha esiste in universo diverso: decisione espandi universo o abbandona S7) → ESEGUITO 2026-07-03, vedi reports/s7_backtest/ALPHA_A5_gate_report_2026-07-03.md — **INCONCLUSIVE**: 0 eventi (Finnhub free-tier `calendar/earnings` copre solo ~30gg storici, non l'anno richiesto; harness usa Finnhub non FMP come qui specificato — decisione vendor PO-riservata, stop point §9.2) |
