...
| R-07 | **Controlled paper trading not started** — no live-market data has flowed through the production stack; all validation is against historical data and paper-simulated order flow | HIGH | N/A (known gap) | Open | Maintainer | Authorization blocked pending P2-05 + Kimi P2 Audit |
