...
C) Committa i ledger e il report SOLO SE il branch corrente e' main. Controlla PRIMA:
   ...
   - Se stampa "main": committa.
     ...
     divergenza col remoto) NON forzarlo: riprova il push una volta sola dopo la
     sincronizzazione; se fallisce ancora, lascia il commit locale e segnalalo a stdout.
